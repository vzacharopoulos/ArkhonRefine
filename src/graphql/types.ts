...
export type PporderlineStatusChangedSubscription = { pporderlineStatusChanged: (
    Pick<Pporderlines2, 'id' | 'status'>
...
export type PporderUpdatedSubscription = { pporderUpdated: Pick<Pporders, 'id' | 'status' | 'panelcode' | 'pporderno' | 'estStartDate' | 'estFinishDate' | 'offtimeduration' | 'offtimestartdate' | 'offtimeenddate' | 'pauseduration' | 'pausestartdate' | 'pauseenddate'> };
...
export type UpdatePauseDetailsMutation = { updatePauseDetails: Pick<PanelMachinePauses, 'id' | 'pporderid' | 'pausestartdate' | 'pauseenddate' | 'pauseduration' | 'pausecomment'> };
...
export type CreateCompletePauseMutation = { createCompletePause: Pick<PanelMachinePauses, 'id' | 'pporderid' | 'pausestartdate' | 'pauseenddate' | 'pauseduration' | 'pausecomment'> };
...
export type DeleteMachinePauseMutation = Pick<Mutation, 'deleteMachinePause'>;
...
export type UpdatePporderMutation = { updatePporder: (
    Pick<Pporders, 'pporderno' | 'id' | 'status' | 'startDateDatetime' | 'finishDateDatetime' | 'estStartDate' | 'estFinishDate' | 'previd' | 'prevpanelcode' | 'offtimeduration' | 'offtimestartdate' | 'offtimeenddate'>
    & { pauses?: Maybe<Array<Pick<PanelMachinePauses, 'id' | 'pausestartdate' | 'pauseenddate' | 'pauseduration' | 'pausecomment'>>>, pporderlines: Array<Pick<Pporderlines2, 'status' | 'upDate'>> }
  ) };
...
export type GetPpOrdersQuery = { pporders: Array<(
    Pick<Pporders, 'id' | 'pporderno' | 'panelcode' | 'status' | 'startDateDatetime' | 'finishDateDatetime' | 'estDateOfProdDatetime' | 'createDate' | 'estStartDate' | 'estFinishDate' | 'previd' | 'prevpanelcode' | 'offtimeduration' | 'offtimestartdate' | 'offtimeenddate'>
    & { pauses?: Maybe<Array<Pick<PanelMachinePauses, 'id' | 'pausestartdate' | 'pauseenddate' | 'pauseduration' | 'pausecomment'>>> }
  )> };
...
export type GetMasterlengthQuery = { masterlengths: Array<Pick<Masterlength, 'pporderno' | 'id' | 'code' | 'startDateDatetime' | 'finishDateDatetime' | 'totalMeter' | 'status' | 'time' | 'previd' | 'prevpanelcode' | 'offtimeduration' | 'offtimestartdate' | 'offtimeenddate'>> };
...
export type GetPpOrderLinestopporderQuery = { pporderlines2: (
...
export type PpOrderLine2Query = { pporderlines2: (
    Pick<Pporderlines2Response, 'totalCount'>
    & { nodes: Array<(
...
export type UpdateOneCoilMutation = { updateOneCoil: Pick<Coil, 'id' | 'comments' | 'thickness'> };

export type GetAllLocationsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetAllLocationsQuery = { locations: Array<Pick<Location, 'shortname' | 'whgroup' | 'atlaid' | 'atlaname' | 'comid'>> };
...
export type UserQuery = { user?: Maybe<Pick<Users, 'userId' | 'role' | 'name' | 'id' | 'password' | 'email' | 'phone' | 'atlaname' | 'name2'>> };
...
export type GetDailyWorkingHoursQuery = { workingHours?: Maybe<Pick<WorkingHours, 'date' | 'startHour' | 'startMinute' | 'endHour' | 'endMinute' | 'isWorkingDay'>> };

export type GetWorkingHoursQueryVariables = Exact<{ [key: string]: never; }>;


export type GetWorkingHoursQuery = { workingHoursAll: Array<Pick<WorkingHours, 'date' | 'startHour' | 'startMinute' | 'endHour' | 'endMinute' | 'isWorkingDay'>> };
